import { MoodNode, MoodCategory, TimePoint } from './types';
...
export const MOOD_NODES: MoodNode[] = [
  {
    ...
    description:
      'O ponto zero. Equilíbrio entre energia e emoção, com reatividade apropriada aos eventos e estabilidade.',
  ...
  },
  {
    ...
    label: 'Ciclotimia',
    description:
      'Instabilidade persistente do humor envolvendo numerosos períodos de sintomas hipomaníacos e depressivos leves. Flutuação crônica que não atinge critérios para Episódio Maior, mas causa sofrimento.',
  ...
  },
  {
    ...
    description:
      'Estado caracterizado por humor deprimido profundo, anedonia (perda de prazer) e energia extremamente baixa. Isolamento e desesperança são comuns.',
  ...
  },
  {
    ...
    label: 'Distimia',
    description:
      'Depressão crônica de leve a moderada intensidade. Persistente, mas com funcionalidade preservada, embora reduzida.',
    category: MoodCategory.Depressive,
  ...
  },
  {
    ...
    label: 'Hipomania',
    description:
      'Elevação do humor e energia. Produtividade aumentada, otimismo, sem sintomas psicóticos. Muitas vezes percebido como agradável pelo paciente.',
  ...
  },
  {
    ...
    label: 'Mania Franca',
    description:
      'Elevação extrema do humor, grandiosidade, aceleração do pensamento, impulsividade e risco. Pode incluir sintomas psicóticos.',
    category: MoodCategory.Manic,
  ...
  },
  {
    ...
    label: 'Estado Misto',
    description:
      'Coexistência de sintomas maníacos (energia, aceleração) e depressivos (disforia, desespero). Altíssimo risco de suicídio devido à energia para agir combinada com sofrimento.',
    category: MoodCategory.Mixed,
  ...
  },
  {
    ...
    description:
      'Humor depressivo acompanhado de inquietação psicomotora severa, angústia e irritabilidade.',
    category: MoodCategory.Mixed,
  ...
  },
  {
    ...
    label: 'Catatonia',
    description:
      'Imobilidade motora ou atividade motora excessiva sem propósito, negativismo extremo. Pode ocorrer na depressão ou mania.',
    category: MoodCategory.Mixed,
...
export const DEFAULT_MOOD_ID = 'euthymia';

export const MOOD_PANEL_CONTENT: Record<
  string,
  {
    insight: string;
    elevation: number;
...
> = {
  ...
  'agitated-depression': {
    elevation: 0.22,
    insight:
      'Na depressão agitada, o sofrimento depressivo não aparece como pura lentificação, mas como tormenta psicomotora. O paciente não apenas sofre: ele sofre em movimento, em angústia, em inquietação, em atrito consigo mesmo. Essa forma clínica é importante porque corrige a caricatura de que toda depressão grave é silenciosa ou inibida. Aqui, o desespero pode vir acompanhado de tensão, irritabilidade e urgência subjetiva.',
  },
  catatonia: {
    elevation: 0.03,
    insight:
